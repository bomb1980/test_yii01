...
class EmpstateTb extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ems_status', 'numerical', 'integerOnly'=>true),
			...
			array('ems_id, ems_registernumber, ems_accno, ems_accbran, ems_email, ems_startdate, ems_createby, ems_created, ems_updateby, ems_modified, ems_remark, ems_status', 'safe', 'on'=>'search'),
		);
	}
