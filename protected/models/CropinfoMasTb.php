...
/**
 * This is the model class for table "cropinfo_mas_tb".
 *
 * The followings are the available columns in table 'cropinfo_mas_tb':
 ...
 */
class CropinfoMasTb extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CropinfoMasTb the static model class
	 */
