...
/**
 * This is the model class for table "branch_mas_tb".
 *
 * The followings are the available columns in table 'branch_mas_tb':
 ...
 */
class BranchMasTb extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BranchMasTb the static model class
	 */
