...
class CropVBran extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cbid, brch_id, crop_id, ordernumber, crop_status', 'numerical', 'integerOnly'=>true),
			...
			array('cbid, brch_id, crop_id, registernumber, ordernumber, ampcode, SSO_BRAN_CODE, SSO_BRN_NAME, ZONE_AMPUR_NAME, registerdate, registername, tsic, tsicname, address, email, phonenumber, faxnumber, acc_no, acc_bran, crop_remark, crop_createtime, crop_updatetime, crop_status', 'safe', 'on'=>'search'),
		);
	}
