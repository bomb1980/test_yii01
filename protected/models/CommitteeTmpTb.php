...
/**
 * This is the model class for table "committee_tmp_tb".
 *
 * The followings are the available columns in table 'committee_tmp_tb':
 ...
 */
class CommitteeTmpTb extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CommitteeTmpTb the static model class
	 */
