...
/**
 * This is the model class for table "sapainstxtfile2_tb".
 *
 * The followings are the available columns in table 'sapainstxtfile2_tb':
 ...
 */
class Sapainstxtfile2Tb extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Sapainstxtfile2Tb the static model class
	 */
