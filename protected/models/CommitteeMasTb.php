...
/**
 * This is the model class for table "committee_mas_tb".
 *
 * The followings are the available columns in table 'committee_mas_tb':
 ...
 */
class CommitteeMasTb extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CommitteeMasTb the static model class
	 */
