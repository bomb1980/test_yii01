...
/**
 * This is the model class for table "ledriskcrop2_tb".
 *
 * The followings are the available columns in table 'ledriskcrop2_tb':
 ...
 */
class Ledriskcrop2Tb extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Ledriskcrop2Tb the static model class
	 */
	 
	public $CountOflrc_registernumber; 
	...
	public function rules()
	{
		...
		return array(
			...
			array('lrc_amphur, lrc_province, lrpt_abs_prot, lrpt_abs_gaz, lrpt_abs_due, lrpt_bkr_prot, lrpt_req, lrpt_lastupdate, lrpt_df_id, lrpt_df_name, lrpt_df_surname', 'length', 'max'=>255),
			array('lrc_createby, lrc_updateby', 'length', 'max'=>100),
			array('lrc_registername, lrc_address, lrc_created, lrc_modified, lrc_remark', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('lrc_id, lrc_accno, lrc_bran, lrc_registernumber, lrc_registername, lrc_ssocode1, lrc_ssocode2, lrc_address, lrc_amphur, lrc_province, lrc_zipcode, lrc_createby, lrc_created, lrc_updateby, lrc_modified, lrc_remark, lrc_status, lrpt_abs_prot, lrpt_abs_gaz, lrpt_abs_due, lrpt_bkr_prot, lrpt_req, lrpt_lastupdate, lrpt_df_id, lrpt_df_name, lrpt_df_surname', 'safe', 'on'=>'search'),
		);
	}
