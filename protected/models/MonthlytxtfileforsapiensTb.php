...
/**
 * This is the model class for table "monthlytxtfileforsapiens_tb".
 *
 * The followings are the available columns in table 'monthlytxtfileforsapiens_tb':
 ...
 */
class MonthlytxtfileforsapiensTb extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MonthlytxtfileforsapiensTb the static model class
	 */
	...
	{
		return 'monthlytxtfileforsapiens_tb';
	}
