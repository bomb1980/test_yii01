...
if($countb>0){
		...
		foreach ($resulcrop as $rows){
			...
			//echo "{$registername}, {$len}, {$count_registername_arr} <br>"; 
			//var_dump($registername_arr);
			//echo "<br>{$registername_arr[0]}<br> {$registername_arr[1]}";
			//exit;
		    ...
		    /*if(isset($registername_arr[1])){
				$registername_arr[1] = $registername_arr[1];
			}else{
				$registername_arr[1] = "";
			}*/		
