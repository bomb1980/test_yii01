...
<body>
				  ...
				  ?> 
                      <tr>
                          ...
                          <td style="text-align:center; color:green;">
                          	...
                          	<button class="btn btn-primary" title="อัปโหลดไฟล์ขึ้น SFTP" onClick="javascript:calluploadfiletosftp(<?=$gtf_id?>,'<?=$gtf_name?>',<?=$rownum?>);"><i class="fa fa-upload"></i> <font class="thfont5" style="height:auto;">Upload to SFTP</font></button>
                            <?php }else{ ?>
                            	Success
                            <?php } ?>
                            </div>
    ...
    <?php
		...
		$lremark = "แสดงรายการtextfileที่เคยสร้างไว้แล้วในระบบ&จำนวน=" . $counttf . "ไฟล์";
