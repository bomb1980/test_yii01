...
?>
    ...
    <?php
		...
		$q = new CDbCriteria( array(
    		...
    		'params'    => array(':registerdate' => "{$datesch1}", ':crop_remark' => "P")  // Aha! Wildcards go here
		));
		
        $resultp = CropinfoTmpTb::model()->findAll($q);
		$countp = count($resultp);
		
		echo "จำนวน : {$countp} รายการ";
	?>
    </div>
