...
//$section = file_get_contents('http://platformext.rd.go.th/TaxData/api/GetListPNDInformationSos/%7B%22NIDSearch%22:%22' . $seltxt . '%22,%22branchNo%22:%22000000%22,%22formCode%22:%22PND1%22,%22taxYear%22:%22' . $schtxt . '%22,%22taxMonthBegin%22:%221%22,%22taxMonthEnd%22:%2212%22,%22NIDStatus%22:%220%22%7D');
//$section = file_get_contents('http://platformext.rd.go.th/TaxData/api/GetListPNDInformationSos/%7B%22NIDSearch%22:%22'.$seltxt.'%22,%22branchNo%22:%22000000%22,%22formCode%22:%22PND1%22,%22taxYear%22:%22'.$schtxt.'%22,%22taxMonthBegin%22:%221%22,%22taxMonthEnd%22:%2212%22,%22NIDStatus%22:%220%22%7D');
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div id="resega1" class="thfont5" style="font-size:24px; color:#666; width:100%; height:auto;">
                        <?php for ($i = 0; $i <= count($sortpndmonth) - 1 ; $i++) {
...
<script>
    ...
    function exportpnd() {
        ...
        var result = confirm("ต้องการดาวน์โหลดรายละเอียด ภงด.01 <?php echo $nid; ?> ?");
        if (!result) {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                if (data.status == 'success') {
                    ...
                    var fileName = 'downloadPND01_<?php echo $nid; ?>_' + year + month + day + "_" + hour + mins + sec;
