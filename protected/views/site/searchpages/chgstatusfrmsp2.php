    	...
    	<div class="col-md-12">
            ...
            <table id="chgstatus1" cellpadding="5" class="table4_1 display row-border responsive nowrap" style="width:100%; height:auto; color:#003;">
      			...
      			<tbody>
					...
					//ค้นหาข้อมูล EmpstateTb
					$empmodel=EmpstateTb::model()->findByAttributes(array('ems_registernumber'=>$registernumber));
					$ems_startdate = $empmodel->ems_startdate;
					$ems_email = $empmodel->ems_email;
					$ems_numofemp = $empmodel->ems_numofemp;
					$ems_totalsalary = $empmodel->ems_totalsalary;
					
					$eday1 = date_create($ems_startdate)->format('d');
			 		$emth1 = date_create($ems_startdate)->format('m');
			 		$eyer1 = date_create($ems_startdate)->format('Y')+543;
					$edate1 = $eday1 . "-" . $emth1 . "-" . $eyer1;
                    ...
                    <tr>
                        ...
                        <td style="text-align:left; width:60%; padding-left:15px;">
							<input type="text" onFocus="this.select()" onBlur="chkelm(this.id);" class="mytextbox thfont5" style="height:auto;" id="dateemp" value="<?=$edate1?>" placeholder="" readonly><span id="inlineDate"></span>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left; width:60%; padding-left:15px;">
                        	<input type="text" onFocus="this.select()" onBlur="chkelm(this.id);" class="mytextbox thfont5" style="height:auto;" id="numemp1" value="<?=$ems_numofemp?>" placeholder=""> คน &nbsp;
                    ...
                    <tr>
                        ...
                        <td style="text-align:left; width:60%; padding-left:15px;">
                        	<input type="text" onFocus="this.select()" onBlur="chkelm(this.id);" class="mytextbox thfont5" style="height:auto;" id="numemp2" value="<?=$ems_totalsalary?>" placeholder=""> บาท
                    ...
                    <tr>
                        ...
                        <td style="text-align:left; width:60%; padding-left:15px;">
							<input type="text" onFocus="this.select()" onBlur="chkelm(this.id);"  class="form-control thfont5" style="height:auto;" id="emailcorp" placeholder="Example@email.com" value="<?=$ems_email?>">
           ...
           <div style="color:red;"><span style="text-decoration: underline;"><b>คำเตือน</b></span>: <br> &nbsp;&nbsp;&nbsp; กรณีที่บันทึกขึ้นทะเบียนนายจ้างที่ระบบ WCF แล้ว
หากมีการแก้ไขข้อมูลที่ระบบ WPD ต้องไปแก้ไขข้อมูลที่ระบบ WCF ด้วย </div>
