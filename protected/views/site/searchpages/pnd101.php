<script>
  ...
  function ajaxcallpnd101(seltxt, schtxt) {
    var data1 = 'action=sch&schtxt=' + schtxt + "&seltxt=" + seltxt;
    $('#pain').html("<img src='<?php echo Yii::app()->request->baseUrl; ?>/themes/vcard/images/preloader-01.gif' height='30' width='30' /> <br> Loading...");
    $.ajax({
      type: "POST",
...
<div id="a2">
  <div id="txtfilter1">
    <!--textbox filter-->
    <div class="about_title thfont5" style="font-size:30px;">(ภ.ง.ด.1_01) ค้นหาข้อมูลรายการภาษีเงินได้นิติบุคคล ด้วยเลขประจำตัวผู้เสียภาษีอากร และ ปี พ.ศ. </div>
    <div class="row">
      ...
      <div class="col-xs-12 col-md-2 col-lg-2">
        <div class="form-group" style="" id="dbtn1">
          <p class="thfont5" style="padding-top:32px;">
            ...
            <button class="btn btn-info" id="btn1" onClick="javascript:callpnd101();"><i class="fa fa-search"></i>
