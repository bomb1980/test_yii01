...
<script type="text/javascript">
	...
	function selectbrn(sv1){
		...
		$.ajax({
			type: "POST", 
			url: "<?php echo Yii::app()->createAbsoluteUrl('site/callsubrptled31'); ?>",      
			data: data1,         
			success: function (da)
			{
			   $("#rp1").html(da);
    ...
    <div id="rpttoolbar">
        <div class="thfont5">
            <div style="float:left; width:30%; padding-bottom:5px;">
            	<!--<div style="float:left; width:40%;">จากวันที่: <input type="text" id="datepicker1" class="thfont3" style="padding-left:5px; width:90px; border-radius:5px;" readonly></div>
                <div style="float:left; width:40%;">ถึงวันที่: <input type="text" id="datepicker2" class="thfont3" style="padding-left:5px; width:90px; border-radius:5px;" readonly></div>-->
