...
class __TwigTemplate_5ef75b7872f4702f4c67e878dc4ef12b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo call_user_func_array($this->env->getFilter('error')->getCallable(), [_gettext("Configuration contains incorrect data for some fields.")]);
        echo "
...
";
    ...
    {
        return new Source("", "preferences/manage/error.twig", "D:\\wamp\\www\\admin\\templates\\preferences\\manage\\error.twig");
    }
}
